...
const NETWORKS = [
  ...
  { label: "tk", name: "TikTok", href: undefined, hoverBg: "hover:bg-blue" },
];

export function SocialLinks({ size = "sm", liveUrl }: { size?: "sm" | "md"; liveUrl?: string }) {
